...
Keller-Ressel and Nikulski (2026) use symbolic regression to discover analytic
...
paper. This notebook supplies that analysis, applying the standard slice-level
no-arbitrage conditions to SVI, $f_4$, and the C6 / C8 forms in Keller-Ressel & Nikulski (2026).
...
3. **ApplicationsL** The diagnostics are then applied to (i) a representative
